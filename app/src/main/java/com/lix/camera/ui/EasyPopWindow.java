 ...
 */
public class EasyPopWindow extends PopupWindow {
    ...
    public EasyPopWindow(Context context, int width) {
        this(context, width, ViewGroup.LayoutParams.WRAP_CONTENT);
    }

    public EasyPopWindow(Context context, int width, int height) {
        super(width, height);
        if(width < 0) {
